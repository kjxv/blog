...
![封面图](images/01-1.jpg){ .hide-in-post width="300" align="left" style="border-radius: 8px; margin-right: 20px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); margin-bottom: 10px;" }
...
<div class="tutorial-divider">
  ...
  <p>从下面开始是完整图文教程，适合想系统了解 Xesim / eSIM 的朋友按步骤阅读。</p>
</div>
...
![Xesim 是 eSIM 配置文件的容器](images/19_selfmade_esim_container_diagram.svg){ style="display:block; width:100%; max-width: 920px; margin: 24px auto; border-radius: 12px; box-shadow: 0 6px 18px rgba(15,23,42,0.10);" }

## 二、 eSIM 的 8 大神仙应用场景

如果你还在犹豫是否需要 eSIM，看看以下几个场景是否击中你的痛点：

![eSIM 的 8 大应用场景](images/20_selfmade_8_scenarios_infographic.svg){ style="display:block; width:100%; max-width: 920px; margin: 20px auto 28px; border-radius: 12px; box-shadow: 0 6px 18px rgba(15,23,42,0.10);" }
...
![X2 Pro SeedLink 使用示意](images/Xesim-1.png){ style="display:block; width:100%; max-width: 920px; margin: 20px auto 28px; border-radius: 12px; box-shadow: 0 6px 18px rgba(15,23,42,0.10);" }
...
![Xesim App 官方截图](images/Xesim-2.png){ style="display:block; width:100%; max-width: 920px; margin: 20px auto 28px; border-radius: 12px; box-shadow: 0 6px 18px rgba(15,23,42,0.10);" }
